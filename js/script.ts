...
function toggleLoader(show:boolean) {
    const loader  = document.getElementById("login-loader") as HTMLElement;
...
async function loginUser(username:string , password:string){
   ...
   try {
    ...
    // Définit le type des utilisateurs retournés par l’API afin de typer correctement les données JSON
        interface User {
        id: string;
        username: string;
        password: string;
...
loginSubmitBtn.addEventListener("click", (e : MouseEvent) => {
