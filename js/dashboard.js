...
var daysContainer = document.getElementById("weekDays");
...
var coreCharte = document.getElementById("core-charte");
// Recupere le canvas utilise pour afficher le graphique circle
var circleChart = document.getElementById("circle-chart");
...
var startOfWeek = new Date(today.getTime());
...
for (var i = 0; i < 7; i++) {
    ...
    var date = new Date(startOfWeek.getTime());
    ...
    div.innerHTML = "\n    <span>".concat(days[date.getDay()], "</span>\n    <span class=\"date\">").concat(date.getDate(), "</span>\n  ");
